  ...
  <div>
    <Container>
      ...
      <h1 class="headline text-blue-500 mb-6">
        {{ $t('homeDashboard.uniqueOffersChart.label.main')}}
      </h1>
        ...
        <div class="flex justify-end mb-2">
          <div class="select-wrapper">
            <MultiSelect
                ...
                :label="$t('homeDashboard.uniqueOffersChart.filter.groupBy.label')"
        ...
        >
          <div class="select-wrapper">
            <MultiSelect
                ...
                :label="$t('homeDashboard.uniqueOffersChart.filter.month.label')"
        ...
        <div class="flex justify-end mb-2">
          <div class="select-wrapper">
            <MultiSelect
                ...
                :label="$t('homeDashboard.uniqueOffersChart.filter.year.label')"
  ...
  data(): ComponentData {
    return {
      ...
      groupBySelect: {
        ...
        options: [
          {
            label: this.$t('homeDashboard.uniqueOffersChart.filter.groupBy.options.day'),
            value: "day",
          },
          {
            label: this.$t('homeDashboard.uniqueOffersChart.filter.groupBy.options.month'),
            value: "month",
          }
        ]
      }
          ...
          datasets: [
            {
              ...
              label: this.$t('homeDashboard.uniqueOffersChart.label.tooltip.countOfFoundOffers'),
